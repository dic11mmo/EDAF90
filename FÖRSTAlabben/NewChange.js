...
/*let f = Object.filter(imported.inventory, item => item.foundation);
let p = Object.filter(imported.inventory, item => item.protein);
let ex = Object.filter(imported.inventory, item => item.extra);
let dres= Object.filter(imported.inventory, item => item.dressing);*/
...
v.forEach(key => {
    if (imported.inventory[key].foundation == true) {
        console.log( " imported.inventory[key] ");
        console.log(imported.inventory[key]);
